...
const Contacts = () => (
  <section className="contacts" aria-label="страница контактов компании">
    ...
    <div className="contacts__team">
      <img src={teamImg} alt="фотография команды" />
      <div className="contacts__team_description">
        <h3 className="contacts__team_header">Наша команда</h3>
        <p className="contacts__team_info">
          Наша команда — это группа амбициозных профессионалов, преданная идеи
          поддержки айти специалистов. Мы создали эту сеть коворкингов, чтобы
